...
module.exports = __webpack_require__(/*! C:\Haseeb\Project\Interactive-Comments-Section\src\main.ts */"zUnb");
...
CommentsSectionComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CommentsSectionComponent, selectors: [["app-comments-section"]], decls: 11, vars: 1, consts: [[4, "ngIf"], ["id", "deleteModal"], [1, "fw-500", "modal-title"], [1, "modal-context"], [1, "update__btns", "d-flex"], [1, "btn", "bg-grayish-blue", "btn-secondary-fill", 3, "click"], [1, "btn", "bg-soft-red", "btn-delete-fill", 3, "click"], ["class", "comments", 4, "ngFor", "ngForOf"], [3, "currentUser", "add"], [1, "comments"], [3, "comment", "currentUser", "update", "delete", "vote"], ["class", "replies", 4, "ngIf"], [1, "replies"], [4, "ngFor", "ngForOf"]], template: function CommentsSectionComponent_Template(rf, ctx) { if (rf & 1) {
...
TimePassed.ɵfac = function TimePassed_Factory(t) { return new (t || TimePassed)(); };
TimePassed.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({ name: "getPassedTime", type: TimePassed, pure: true });
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 4, vars: 0, consts: [[1, "container"], [1, "header"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
CardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CardComponent, selectors: [["app-card"]], inputs: { comment: "comment", currentUser: "currentUser" }, outputs: { update: "update", delete: "delete", vote: "vote" }, decls: 20, vars: 13, consts: [[1, "card", "bg-white", "d-flex"], [1, "card__vote"], [3, "vote", "currentUser", "voted"], [1, "card__content"], [1, "card__header", "d-flex"], [1, "card__image"], ["alt", "comment.user.username", 3, "src"], [1, "card__name", "text-dark-blue", "fw-500"], ["class", "bg-blue text-white you", 4, "ngIf"], [1, "card__buttons"], ["class", "btn-reply text-blue fw-500", 3, "click", 4, "ngIf", "ngIfElse"], ["editDeleteBtns", ""], ["class", "card__text", 4, "ngIf"], [4, "ngIf"], [1, "bg-blue", "text-white", "you"], [1, "btn-reply", "text-blue", "fw-500", 3, "click"], [1, "fa-solid", "fa-reply"], [1, "btn-edit-delete"], [1, "btn-delete", "text-soft-red", "fw-500", 3, "click"], [1, "fa-solid", "fa-trash"], ["class", "btn-edit text-blue fw-500", 3, "click", 4, "ngIf"], [1, "btn-edit", "text-blue", "fw-500", 3, "click"], [1, "fa-solid", "fa-pen"], [1, "card__text"], ["class", "text-blue fw-500", 4, "ngIf"], [1, "text-blue", "fw-500"], [1, "reply__form"], ["placeholder", "Type a comment here...", "name", "reply", "id", "reply", "cols", "100", "rows", "10", 1, "text-area", "text-grayish-blue", "ff-rubik", "text-area--comment", 3, "ngModel", "ngModelChange"], [1, "update__btns"], [1, "btn", "btn-outline--primary", 3, "click"], [1, "btn", "bg-blue", 3, "click"], [3, "currentUser", "replyingTo", "onReplyMode"]], template: function CardComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("vote", ctx.comment.score)("currentUser", ctx.currentUser);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);
...
FormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FormComponent, selectors: [["app-form"]], viewQuery: function FormComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("placeholder", ctx.replyingTo ? "" : "Type a comment here...")("ngModel", ctx.comment);
